...
(() => {
  function mount(){
    ...
    if(header&&nav){
      const shell=document.createElement('div');shell.className='ph-shell';const sidebar=document.createElement('aside');sidebar.className='ph-sidebar';sidebar.innerHTML='<div class="ph-brand"><div class="ph-brand-mark">H</div><span class="ph-brand-name">HospitAll</span><button class="ph-collapse" type="button"></button></div><div class="ph-menu-caption">Pharmacy</div>';
